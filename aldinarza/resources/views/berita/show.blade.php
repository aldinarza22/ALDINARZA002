    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="form-group row">
                    <label class="col-md-4 col-form-label text-md-right">kategori_id</label>
                ...
                <div class="form-group row">
                    ...
                    <label class="col-md-8 col-form-label text-md-left">{!! $Berita->users_id->format('d/m/Y H:i') !!}</label>
                </div>
